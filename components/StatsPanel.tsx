    ...
    <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm p-4 space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h3 className="text-base font-bold text-indigo-700 dark:text-indigo-400">{title}</h3>
        </div>
        {progress.streak >= 2 && (
      ...
      <div>
        ...
        {xpGained && xpGained > 0 && (
          <p className="text-xs text-green-600 dark:text-green-400 font-medium mt-1 animate-pulse">
            +{xpGained} XP!
          </p>
        )}
      </div>
      ...
      <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-100 dark:border-slate-700">
        ...
        <div className="text-center">
          <div className="text-lg font-bold text-slate-800 dark:text-slate-100">{average}%</div>
